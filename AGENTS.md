...
Specify is a Laravel 13 system where humans approve AI actions on code repos. **Read [README.md](README.md) first** for the project tour and [docs/adr/](docs/adr/) for the load-bearing decisions before applying any of the framework conventions below.
...
## Boost-managed framework guidelines

Everything inside the marker block below is regenerated by `php artisan boost:update` — edits there will be overwritten on the next update. Put project-specific guidance in the sections above instead.
